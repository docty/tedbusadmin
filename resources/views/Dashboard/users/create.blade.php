            ...
            <div class="row mt" >
              <div class="col-lg-8 col-lg-offset-2  center">
                <div class="form-panel">
                  <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="{{route('staff.store')}}">
                  @csrf
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="contacts" name="contact" type="text" maxlength="15" required placeholder="233-248-456-132" />
                    </div>
                  </div>
