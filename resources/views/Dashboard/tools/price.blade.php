                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           ...
                           @include('Dashboard.tools.price_table')
            ...
            const element = '<div class="modal-dialog">'+
               '<div class="modal-content">'+
                  '<div class="modal-header modal-header-primary">'+
                     ...
                     '<h3><i class="fa fa-user m-r-5"></i> Delete Price</h3>'+
                  '</div>'+
                  '<div class="modal-body">'+
                     '<div class="row">'+
                        '<div class="col-md-12">'+
                           `<form class="form-horizontal" method="POST" action="/price/${id}">`+
                              `<input type="hidden" name="_token" value="${csrf}">`+
                              '<input type="hidden" name="_method" value="delete">'+
                              '<fieldset>'+
                                 '<div class="col-md-12 form-group user-form-group">'+
                                    '<label class="control-label">Are you sure to delete price</label>'+
