    ...
    <!--main content start-->
     <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          <div class="showback">
                <a type="submit" href="{{ route('staff.edit', $staff->urlId) }}" class="btn btn-theme03">Edit Staff</a>
          </div>
          <div class="col-lg-12">
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                <h3>{{$staff->surname}} {{$staff->otherName}}</h3>
                <h6>Junior Staff</h6>
            ...
            <div class="row content-panel">
              <div class="panel-heading">
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li class="active">
                    <a data-toggle="tab" href="#customer" class="contact-map">Customers</a>
                  </li>
                ...
                <div class="tab-content">
                  ...
                  <div id="customer" class="tab-pane active">
                    <div class="row">
                       ...
                       @include('Dashboard.staff.customer_table')
