                        ...
                        <div class="panel-body">
                           ...
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                 <a class="btn btn-add" href="/customers/create"> <i class="fa fa-plus"></i> Add Customer
                                 </a>  
                              </div>
                           ...
                           @include('Dashboard.customers.customers_table')
            ...
            const element = '<div class="modal-dialog">'+
               '<div class="modal-content">'+
                  ...
                  '<div class="modal-body">'+
                     '<div class="row">'+
                        '<div class="col-md-12">'+
                           `<form class="form-horizontal" method="POST" action="/customers/${id}">`+
